...
public class OrdersRecyclerAdapter extends RecyclerView.Adapter<OrdersRecyclerAdapter.ViewHolder> {
    ...
    public OrdersRecyclerAdapter(Context context, List<OrderParent> parentList) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        v.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(context, ViewOrdersChildActivity.class);
                Bundle bun = new Bundle();
                bun.putString("order_id", ((TextView)v.findViewById(R.id.orderId)).getText().toString());
                intent.putExtras(bun);
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                    ActivityOptionsCompat options = ActivityOptionsCompat.
                            makeSceneTransitionAnimation((Activity)context,cardView , context.getResources().getString(R.string.view_orders_transition));
